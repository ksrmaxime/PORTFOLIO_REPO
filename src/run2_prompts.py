...
SYSTEM_PROMPT = (
    ...
    "Base-toi uniquement sur ce que l'article réglemente réellement, "
    "pas sur des associations de termes juridiques ou sectoriels avec l'IA.\n\n"
    ...
    "- Un article qui impose des obligations de conservation de données, "
    "de notification électronique ou de tenue de registres numériques : "
    "le fait qu'une obligation soit remplie par voie électronique ou "
    "numérique ne suffit pas — l'objet doit être le traitement automatisé "
    "ou algorithmique de ces données, pas leur simple stockage ou transmission\n"
