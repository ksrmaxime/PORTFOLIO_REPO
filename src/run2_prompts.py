...
SYSTEM_PROMPT = (
    ...
    "- cite une délégation de pouvoir, facultative (« peut prévoir », « peut décider ») "
    "ou obligatoire mais purement énumérative (« règle », « fixe la liste de »), "
    ...
    "- assimile une répartition par défaut de la responsabilité civile entre acteurs "
    "privés (détenteur, propriétaire, tiers, lésé) ou des modalités générales "
    "d'indemnisation à un instrument de politique publique, alors que ce sont des "
    ...
    "- ignore une sanction, une assurance obligatoire, ou un mécanisme de "
    "responsabilité servant à faire appliquer une obligation réglementaire précise "
    "(à distinguer de la simple répartition de la responsabilité civile entre "
    "acteurs privés, qui n'est pas un instrument)\n"
