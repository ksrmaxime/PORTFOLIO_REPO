...
SYSTEM_PROMPT = (
    ...
    "   Mécanismes de responsabilité servant de levier d'application d'une "
    "obligation réglementaire précise : saisie et confiscation, sanctions "
    "administratives ou pécuniaires pour non-respect d'une règle, assurance "
    "obligatoire, retrait ou prolongement d'un permis en cas d'infraction. "
    "N'inclut PAS la répartition par défaut de la responsabilité civile entre "
    "acteurs privés (détenteur, propriétaire, tiers, lésé) ni les modalités "
    "générales d'indemnisation, qui relèvent du droit privé.\n\n"
    "RÈGLES DE CODAGE :\n"
